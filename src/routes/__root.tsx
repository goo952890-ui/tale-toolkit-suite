  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-4 text-muted-foreground">This trail dead-ends here.</p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Honest travel writing, city guides worth using, and reviews without the fluff." },
      { property: "og:title", content: "mysextrip" },
      { property: "og:description", content: "Honest travel writing, city guides worth using, and reviews without the fluff." },
